...
ActiveRecord::Schema.define(version: 20150716235608) do
  ...
  add_index "user_comments", ["commentable_id", "commentable_type"], name: "index_user_comments_on_commentable_id_and_commentable_type", using: :btree
